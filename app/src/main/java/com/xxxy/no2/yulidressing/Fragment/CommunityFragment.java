...
public class CommunityFragment extends Fragment {
    ...
    private String[] tj_usernames ={"是吃香菜","韩大设计师","灰原丽香","是烦烦烦","Faiwj"};
    private int[] tj_likes = {12,5,7,88,9};
    ...
    private String[] ps_usernames ={"阿樊","隔壁的王叔","是吃香菜","韩大设计师","灰原丽香"};
    private int[] ps_likes = {23,14,22,6,18};
    //搭配数据
